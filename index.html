	...
	<body class="is-preload">
		...
		<!-- Header -->
			<section id="header">
				...
				<footer>
					<a href="#banner" class="button style2 scrolly-middle">GET START!</a>
				</footer>
			</section>
		...
		<!-- Banner -->
			<section id="banner">
				...
				<p>네이버 웨일, 구글 크롬의 포터블 버전을 다운할 수 있습니다.</p>
				<footer>
					<a href="https://www.dropbox.com/s/maprqzg2df15opb/Whale.zip?dl=0" class="button style2 scrolly">Whale.zip</a>
					<a href="https://www.dropbox.com/s/zxpur0menk9c2fd/Chrome.zip?dl=0" class="button style2 scrolly">Chrome.zip</a>
				</footer>
			</section>
			...
			<article id="first" class="container box style1 right">
				...
				<p>최적화 프로그램들을 다운할 수 있습니다.</p>
				<footer>
					<a href="https://www.dropbox.com/s/shx2opat1ddqc5n/%EC%B5%9C%EC%A0%81%ED%99%94.bat?dl=0" class="button style2 scrolly">최적화.bat</a>
				</footer>
			</article>
		...
		<section id="footer">
			...
			<div class="copyright">
				<ul class="menu">
					<li>&copy; T3RR3T All rights reserved.</li> 
				</ul>
			</div>
		</section>
